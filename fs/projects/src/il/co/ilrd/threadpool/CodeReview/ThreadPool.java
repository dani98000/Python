package il.co.ilrd.threadpool.CodeReview;
...
public class ThreadPool implements Executor {
    ...
    private final Runnable killer = () -> {// used to set number of threads and to shutdown the threadpool
	...
	if (null == command) {
	    throw new IllegalArgumentException("Should pass valid runnable");
	}
     ...
     * within the given timeout. It only makes sense to call the method on
	...
	if (null == command) {
	    throw new IllegalArgumentException("Please pass valid Callable");
	}
